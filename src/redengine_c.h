...
//    - Declaración de redc_session_close en struct RedatamAPI.
//      Esta función existía en el motor libredengine pero no estaba
//      expuesta por el wrapper original. Su exposición permite liberar
//      la memoria de sesión del motor C++ entre extracciones, reduciendo
//      el consumo de RAM en el proceso de extracción por bloques.
//
///////////////////////////////////////////////////////////////////////////
...
struct RedatamAPI {
  ...
  // Agregado por R. Durán (2025): expone redc_session_close del motor.
  std::function<void(session_ptr ptr)> redc_session_close;
